...
contextBridge.exposeInMainWorld('api', {
  ...
  getRunForTarget: (targetId) => ipcRenderer.invoke('get-run-for-target', targetId),
  onRunsChanged: (cb) => ipcRenderer.on('runs-changed', (_e, data) => cb(data)),
  checkScheduleConflicts: (expr, excludeId) => ipcRenderer.invoke('check-schedule-conflicts', expr, excludeId),
  ...
  analyzeSyncFolder: (dir, options) => ipcRenderer.invoke('analyze-sync-folder', dir, options),
  previewSyncRetention: (dir, cfg) => ipcRenderer.invoke('preview-sync-retention', dir, cfg),
  runRetentionNow: (dir, cfg) => ipcRenderer.invoke('run-retention-now', dir, cfg),
  getRetentionProfiles: () => ipcRenderer.invoke('get-retention-profiles'),
  createRetentionProfile: (data) => ipcRenderer.invoke('create-retention-profile', data),
  updateRetentionProfile: (data) => ipcRenderer.invoke('update-retention-profile', data),
  deleteRetentionProfile: (id) => ipcRenderer.invoke('delete-retention-profile', id),
  runRetentionProfile: (id) => ipcRenderer.invoke('run-retention-profile', id),
